...
const Term = () => {
  return (
    <div>
      <p>
        AGREEMENT TO OUR LEGAL TERMS We are Map Artisan ("Company," "we," "us,"
        "our"), a company registered in New York, United States at Stony Brook
        University, Stony Brook, NY 11790. We operate the website
        https://calm-meadow-021492f0f.4.azurestaticapps.net (the "Site"), as
        ...
        The objective of Map Artisan is to foster a web community for a diverse
        group of map content creators, map enthusiasts, and professionals. It
        will provide users with a powerful collection of tools to create highly
        customizable and creative maps with little to no need for art or design
        software background. The big picture is to turn any information/data and
        transform it into a map visualization that can be used for all purposes
        such as entertainment, infographics, presentations, etc. MapArtisan aims
        to support various data formats, including SHP, GeoJSON, and KML for
        flexibility. Another key goal is to promote interactions among users
        through features such as commenting, messaging, liking, and forking of
        maps. We hope to deliver an application that is flexible, customizable,
        and intuitive, promoting a network flow of ideas, while also making it
        an enjoyable experience. You can contact us by email at __________ or by
        mail to Stony Brook University, Stony Brook, NY 11790, United States.
        These Legal Terms constitute a legally binding agreement made between
        you, whether personally or on behalf of an entity ("you"), and Map
        Artisan, concerning your access to and use of the Services. You agree
        ...
        SERVICES AND YOU MUST DISCONTINUE USE IMMEDIATELY. We will provide you
        with prior notice of any scheduled changes to the Services you are
        using. Changes to Legal Terms will become effective seven (7) days after
        the notice is given, except if the changes apply to security updates,
        and bug fixes, in which case the changes will be effective immediately.
        By continuing to use the Services after the effective date of any
        changes, you agree to be bound by the modified terms. If you disagree
        with such changes, you may terminate Services as per the section "TERM
        AND TERMINATION." All users who are minors in the jurisdiction in which
        they reside (generally under the age of 18) must have the permission of,
        and be directly supervised by, their parent or guardian to use the
        Services. If you are a minor, you must have your parent or guardian read
        and agree to these Legal Terms prior to you using the Services. We
        recommend that you print a copy of these Legal Terms for your records.
        TABLE OF CONTENTS 1. OUR SERVICES 2. INTELLECTUAL PROPERTY RIGHTS 3.
        USER REPRESENTATIONS 4. USER REGISTRATION 5. PURCHASES AND PAYMENT 6.
        CANCELLATION 7. PROHIBITED ACTIVITIES 8. USER GENERATED CONTRIBUTIONS 9.
        CONTRIBUTION LICENSE 10. GUIDELINES FOR REVIEWS 11. SOCIAL MEDIA 12.
        SERVICES MANAGEMENT 13. PRIVACY POLICY 14. COPYRIGHT INFRINGEMENTS 15.
        TERM AND TERMINATION 16. MODIFICATIONS AND INTERRUPTIONS 17. GOVERNING
        LAW 18. DISPUTE RESOLUTION 19. CORRECTIONS 20. DISCLAIMER 21.
        LIMITATIONS OF LIABILITY 22. INDEMNIFICATION 23. USER DATA 24.
        ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES 25. CALIFORNIA
        USERS AND RESIDENTS 26. MISCELLANEOUS 27. CONTACT US 1. OUR SERVICES The
        ...
        (GLBA). 2. INTELLECTUAL PROPERTY RIGHTS Our intellectual property We are
        ...
        service marks, and logos contained therein (the "Marks"). Our Content
        and Marks are protected by copyright and trademark laws (and various
        ...
        non-commercial use only. Your use of our Services Subject to your
        ...
        for your personal, non-commercial use. Except as set out in this section
        or elsewhere in our Legal Terms, no part of the Services and no Content
        ...
        your request to: __________. If we ever grant you the permission to
        ...
        understand the (a) rights you give us and (b) obligations you have when
        you post or upload any content through the Services. Submissions: By
        ...
        otherwise, without acknowledgment or compensation to you. Contributions:
        ...
        users of the Services. When you post Contributions, you grant us a
        license (including use of your name, trademarks, and logos): By posting
        ...
        Contributions, and to sublicense the licenses granted in this section.
        Our use and distribution may occur in any media formats and through any
        media channels. This license includes our use of your name, company
        ...
        you provide. You are responsible for what you post or upload: By sending
        ...
        sexually explicit, false, inaccurate, deceitful, or misleading; to the
        extent permissible by applicable law, waive any and all moral rights to
        any such Submission and/or Contribution; warrant that any such
        ...
        edit any such Contributions, we may also suspend or disable your account
        and report you to the authorities. Copyright infringement We respect the
        intellectual property rights of others. If you believe that any material
        available on or through the Services infringes upon any copyright you
        own or control, please immediately refer to the "COPYRIGHT
        INFRINGEMENTS" section below. 3. USER REPRESENTATIONS By using the
        ...
        legal capacity and you agree to comply with these Legal Terms; (4) you
        ...
        through a bot, script or otherwise; (6) you will not use the Services
        ...
        thereof). 4. USER REGISTRATION You may be required to register to use
        ...
        obscene, or otherwise objectionable. 5. PURCHASES AND PAYMENT We accept
        the following forms of payment: You agree to provide current, complete,
        ...
        shall be in __________. You agree to pay all charges at the prices then
        ...
        distributors. 6. CANCELLATION All purchases are non-refundable. You can
        ...
        you are unsatisfied with our Services, please email us at __________. 7.
        PROHIBITED ACTIVITIES You may not access or use the Services for any
        ...
        content from the Services to create or compile, directly or indirectly,
        ...
        commercial enterprise. 8. USER GENERATED CONTRIBUTIONS The Services may
        ...
        any Contributions, you thereby represent and warrant that: The creation,
        ...
        in any manner contemplated by the Services and these Legal Terms. You
        ...
        the Services and these Legal Terms. Your Contributions are not false,
        ...
        these Legal Terms, or any applicable law or regulation. Any use of the
        ...
        rights to use the Services. 9. CONTRIBUTION LICENSE By posting your
        Contributions to any part of the Services or making Contributions
        accessible to the Services by linking your account from the Services to
        ...
        obligation to monitor your Contributions. 10. GUIDELINES FOR REVIEWS We
        ...
        perform, and/or distribute all content relating to review. 11. SOCIAL
        MEDIA As part of the functionality of the Services, you may link your
        ...
        12. SERVICES MANAGEMENT We reserve the right, but not the obligation,
        to: (1) monitor the Services for violations of these Legal Terms; (2)
        ...
        13. PRIVACY POLICY We care about data privacy and security. Please
        review our Privacy Policy: __________. By using the Services, you agree
        ...
        States. If you access the Services from any other region of the world
        ...
        your data to the United States, and you expressly consent to have your
        data transferred to and processed in the United States. 14. COPYRIGHT
        INFRINGEMENTS We respect the intellectual property rights of others. If
        ...
        be advised that pursuant to applicable law you may be held liable for
        damages if you make material misrepresentations in a Notification. Thus,
        if you are not sure that material located on or linked to by the
        Services infringes your copyright, you should consider first contacting
        an attorney. 15. TERM AND TERMINATION These Legal Terms shall remain in
        full force and effect while you use the Services. WITHOUT LIMITING ANY
        OTHER PROVISION OF THESE LEGAL TERMS, WE RESERVE THE RIGHT TO, IN OUR
        SOLE DISCRETION AND WITHOUT NOTICE OR LIABILITY, DENY ACCESS TO AND USE
        OF THE SERVICES (INCLUDING BLOCKING CERTAIN IP ADDRESSES), TO ANY PERSON
        ...
        OR PARTICIPATION IN THE SERVICES OR DELETE YOUR ACCOUNT AND ANY CONTENT
        ...
        criminal, and injunctive redress. 16. MODIFICATIONS AND INTERRUPTIONS We
        ...
        17. GOVERNING LAW These Legal Terms and your use of the Services are
        governed by and construed in accordance with the laws of the State of
        New York applicable to agreements made and to be entirely performed
        within the State of New York, without regard to its conflict of law
        principles. 18. DISPUTE RESOLUTION Informal Negotiations To expedite
        ...
        to the other Party. Binding Arbitration If the Parties are unable to
        ...
        and federal courts located in United States, New York, and the Parties
        ...
        from these Legal Terms. In no event shall any Dispute brought by either
        Party related in any way to the Services be commenced more than one (1)
        ...
        court. Restrictions The Parties agree that any arbitration shall be
        ...
        prior notice. 20. DISCLAIMER THE SERVICES ARE PROVIDED ON AN AS-IS AND
        ...
        TO THE AMOUNT PAID, IF ANY, BY YOU TO US DURING THE SIX (6) MONTH PERIOD
        ...
        YOU, AND YOU MAY HAVE ADDITIONAL RIGHTS. 22. INDEMNIFICATION You agree
        ...
        third party due to or arising out of: (1) your Contributions; (2) use of
        ...
        this indemnification upon becoming aware of it. 23. USER DATA We will
        maintain certain data that you transmit to the Services for the purpose
        ...
        arising from any such loss or corruption of such data. 24. ELECTRONIC
        COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES Visiting the Services,
        ...
        credits by any means other than electronic means. 25. CALIFORNIA USERS
        AND RESIDENTS If any complaint with us is not satisfactorily resolved,
        ...
        95834 or by telephone at (800) 952-5210 or (916) 445-1254. 26.
        MISCELLANEOUS These Legal Terms and any policies or operating rules
        ...
        signing by the parties hereto to execute these Legal Terms. 27. CONTACT
        US In order to resolve a complaint regarding the Services or to receive
        further information regarding use of the Services, please contact us at:
        Map Artisan Stony Brook University Stony Brook, NY 11790 United States
        __________
      </p>
    </div>
  );
